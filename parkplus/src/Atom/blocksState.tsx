...
export const useReinitializeBlocksState = () => {
  const [blocks, setBlocks] = useRecoilState(blocksState);

  // Check if blocks is an empty array and reinitialize if true
  if (blocks.length === 0) {
    setBlocks(initializeblockState);
  }
...
// // Use this hook to reinitialize blocksState when it's set to an empty array
